...
export default function Dashboard() {
    ...
    const isEmptyState = recentTournaments.length === 0 && joinedTournaments.length === 0;
    ...
    return (
        <div className="space-y-6 sm:space-y-8 w-full max-w-full overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-1">
                ...
                {!isEmptyState && recentTournaments.length > 0 && (
            ...
            {isEmptyState ? (
                ...
                <>
                    {/* Only show organizer sections if user has created tournaments */}
                    ...
                    {/* Create Tournament & Tutorial CTAs - always show when no created tournaments */}
                    {recentTournaments.length === 0 && (
                        <div className="space-y-6">
                            {/* Create Tournament CTA */}
                            <div id="tour-create-tournament" className="w-full relative overflow-hidden rounded-xl bg-gradient-to-r from-emerald-900/40 to-teal-900/40 border border-white/10 p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
