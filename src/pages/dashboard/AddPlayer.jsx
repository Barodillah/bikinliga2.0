...
const leagueOptions = [
    ...
    { value: 'Serie BKT', label: 'Serie BKT' },
    ...
    { value: 'AFC Asian Qualifiers – Road to Qatar', label: 'AFC Asian Qualifiers – Road to Qatar' },
    ...
    { value: 'Hilux Revo Thai League', label: 'Hilux Revo Thai League' },
    ...
    { value: 'Liga BBVA MX', label: 'Liga BBVA MX' },
    { value: 'American League', label: 'American League' },
    { value: 'USL Championship', label: 'USL Championship' },
    { value: 'OTHER_EUROPEAN', label: 'Other European Teams' },
    { value: 'OTHER_ASIAN', label: 'Other Asian Teams' },
    { value: 'OTHER_LATAM', label: 'Other Latin American Teams' },
    { value: 'OTHER_AFRICAN', label: 'Other African Teams' },
]
